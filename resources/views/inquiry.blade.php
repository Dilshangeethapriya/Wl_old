...
<body class="font-sans text-gray-900 antialiased"
    ...
    <div class="bg bg-transparent text-white p-10 ">
    ...
    <div class="flex justify-around text-center">
        ...
        <div class="flex flex-col items-center">
            ...
            <p>woodlak@gmail.com</p>
        </div>
    </div>
</div>
 <h2> </h2>
    <div class="flex justify-between p-5 bg-translucent border border-gray-200 rounded-lg shadow-sm">
        ...
        <div class="flex-1 md:flex-none md:w-1/2 p-5">
            ...
            <div id="callback" class="tab-content hidden">
                ...
                <form action="{{ route('addCallBackRequest') }}" method="POST" class="flex flex-col  rounded-lg p-5 ">
                    @csrf
                    <label for="name" class="mt-2 font-semibold text-gray-700">Name</label>
